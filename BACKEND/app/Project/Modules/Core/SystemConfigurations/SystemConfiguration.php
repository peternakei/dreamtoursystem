...
class SystemConfiguration extends Model
{
    ...
    protected $fillable = [
        'system_configuration_type_id', 'value', 'created_by', 'updated_by', 'is_active', 'uuid', 'deleted_at', 'updated_at', 'created_at'
    ];

    public function systemConfigurationType()
    {
        return $this->belongsTo(SystemConfigurationType::class, 'system_configuration_type_id');
    }
