<div id="create-activity-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="standard-modalLabel">Create Activity </h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
            </div>
            <form action="{{ route('activities.store') }}"
                id="createActivityForm" name="createActivityForm" method="POST">
                @csrf
                <div class="modal-body">
                    <h5 style="font-weight: 500;">Fill the form to create new activity </h5>
                    <div class="row mt-3">
                                ...
                                <div class="col-md-12 col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="name"
                                            name="name" placeholder="Enter activity name"
                ...
                <div class="modal-footer">
                    <button type="button" onclick="submitCreateForm('createActivityForm')"
