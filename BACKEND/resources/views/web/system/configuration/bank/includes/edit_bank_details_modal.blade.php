<div id="edit-bank-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="standard-modalLabel">Edit Bank </h4>
            ...
            <form id="editBankForm" name="editBankForm" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="bank_name" name="name"
                                            placeholder="Enter bank name" class="form-control" required>
                ...
                <div class="modal-footer">
                    <button type="button" onclick="submitCreateForm('editBankForm')"
