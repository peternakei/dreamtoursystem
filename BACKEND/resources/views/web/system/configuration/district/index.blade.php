                                    ...
                                    <tbody>
                                        @foreach ($districts as $district)
                                            <tr>
                                                ...
                                                <td><span class="badge"
                                                        style="background-color: @if ($district->is_active) green @else orangered @endif">
                                                ...
                                                <td>{{ $district->createdBy?->userProfile?->name ?? '—' }}</td>
                                                <td class="table-action">
                                                    <a href="{{ route('districts.show', $district->uuid) }}"
