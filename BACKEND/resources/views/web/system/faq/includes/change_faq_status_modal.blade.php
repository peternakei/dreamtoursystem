<div id="change-faq-status-modal" class="modal fade" tabindex="-1" role="dialog"
    aria-labelledby="standard-modalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="standard-modalLabel">Change <span
                        class="text-primary">{!! $faq->name !!}</span>`s Status</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
            </div>
            <form action="{{ route('faqs.change_status', $faq->uuid) }}"
                id="changeFaqStatusForm" name="changeFaqStatusForm" method="POST">
                @csrf
                <div class="modal-body">
                    <h5 style="font-weight: 500;">Fill the form to change faq status</h5>
                    <div class="row mt-3">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <select class="form-control select2" id="current_status" name="current_status"
                                            ...
                                            <optgroup label="Current Status">
                                                ...
                                                <option value="{{ $faq->is_active }}" selected>
                ...
                <div class="modal-footer">
                    <button type="button" onclick="submitCreateForm('changeFaqStatusForm')"
