<div id="edit-permission-modal" class="modal fade" tabindex="-1" permission="dialog" aria-labelledby="standard-modalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="standard-modalLabel">Edit Permission </h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
            </div>
            <form id="editPermissionForm" name="editPermissionForm" method="POST">
                @method('PUT')
                @csrf
                <div class="modal-body">
                    <h5 style="font-weight: 500;">Fill the form to edit permission </h5>
                    <div class="row mt-3">
                                ...
                                <div class="col-md-12 col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <div class="table-section py-0" data-simplebar
                                            ...
                                            <table class="table table-bordered table-hover table-centered mb-0" id="permissionRolesTable">
                                                ...
                                                <tbody id="permissionRoleSection">
                ...
                <div class="modal-footer">
                    <button type="button" onclick="submitCreateForm('editPermissionForm')"
