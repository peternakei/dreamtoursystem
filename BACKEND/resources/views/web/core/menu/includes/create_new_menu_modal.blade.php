<div id="create-menu-modal" class="modal fade" tabindex="-1" menu="dialog" aria-labelledby="standard-modalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('menus.store') }}" id="createMenuForm" name="createMenuForm" method="POST">
                @csrf
                <div class="modal-body">
                    <h5 style="font-weight: 500;">Fill the form to create new menu </h5>
                    <div class="row mt-3">
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="url" name="url"
                                            placeholder="Enter menu url" class="form-control" required>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" id="ordering" name="ordering"
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control select2" id="menu_parent" name="parent"
                                            data-toggle="select2">
                ...
                <div class="modal-footer">
                    <button type="button" onclick="submitCreateForm('createMenuForm')"
