                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="table-section py-0" data-simplebar
                                            ...
                                            <table class="table table-bordered table-hover table-centered mb-0">
                                                ...
                                                <tbody>
                                                    @foreach ($groupMenusPermissions as $menu => $allPermissions)
                                                        <tr>
                                                            <td>
                                                                <h5
                                                        ...
                                                        @foreach ($allPermissions as $permission)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div
                                                                        class="form-check form-checkbox-info text-center">
                                                                        <input type="checkbox" class="form-check-input"
                                                                            id="permission" name="permission[]"
                                                                            @if (in_array($permission->id, $role->permissions->toArray())) checked @endif
                                                                            value="{{ $permission->id }}">
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="form-check form-checkbox-info text-center">
                                                                    <input type="checkbox" class="form-check-input"
                                                                        id="permission" name="permission[]" @if (in_array($permission->id, $role->permissions->toArray())) checked @endif
                                                                        value="{{ $permission->id }}">
                                                                </div>
                                                            </td>
                                                        </tr>
